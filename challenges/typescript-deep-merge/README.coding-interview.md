...
> **~35–60 minutes**  ·  no AI assistant  ·  graded on correctness **and** how you got there
...
looking at. Whatever you add, the rest of the rules still apply — **don't change
the inputs, and stay safe against `__proto__`.**
...
| Code quality | 20% | Clean recursion, fresh copies instead of edited inputs, normal TypeScript |
