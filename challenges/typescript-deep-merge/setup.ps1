# =============================================================================
# typescript-deep-merge - one-command setup  (Windows / PowerShell)
#
# WHAT THIS IS
...
#   2. Runs `npm install` to pull this challenge's test tools (vitest +
#      TypeScript) into .\node_modules.
#
...
Write-Host "@immutable / @arrays / @security tests fail on purpose - those point at"
