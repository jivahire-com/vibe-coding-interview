...
> **~60 minutes**  ·  no AI assistant  ·  graded on correctness **and** how you got there
...
sharper one of your own** — then decide what the cache should do about it, build it,
and write tests that prove it works.
...
- **Getting it right — 40%.** The hidden tests pass, including the edge cases and the multi-threaded ones, and the planted bugs are fixed.
- **How you worked — 15%.** Building and running the tests as you go, not just at the end.
- **Code quality — 20%.** Clean, readable, sensible C++.
- **Your thinking — 25%.** The choices you made, the bugs you spotted, why your locking is correct, and (if you did it) the optional extension.
